...
for(var i = 1; i <= 40; i++) {
    ...
    if(i<=16){
        ...
        if(i<=32&&i>16){
            enemyArray[i] = new Animation(21.6, 14, 0, 0, 2, 'sprites/enemy2.png', 1, 0, 1);
        }
        else if(i>32){
            enemyArray[i] = new Animation(21.6, 14, 0, 0, 2, 'sprites/enemy3.png', 1, 0, 1);
    ...
    if(i == 8 || i == 16 || i == 24 || i == 32) {
        changingWidth = 0;
        changingHeight += 14; // tova e neshtoto koeto sum promenil;
    }
}
